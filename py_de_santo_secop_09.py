...
class Application(tk.Frame):
    ...
    def define_raiz(self):
        ...
        self.master.title('Py de santo... Secop 09')
    ...
    def formata_texto_nota(self, event=None):
        ...
        if len(texto) == 0:
            ...
            self.imprime_saida('Informe o texto da nota\n\n')
        else:
    ...
    def link_processo(self, event=None):
        ...
        if len(processo) == 0:
            ...
            self.imprime_saida('Informe o processo\n\n')
        else:
    ...
    def abre_triag(self, event=None):
    ...
    def abre_via_cpf(self, event=None):
        '''Abre consulta no VIA para CPF'''
        webbrowser.open("https://via7.suiterfb.receita.fazenda/via/private/pages/consultar_cpf_e1.jsf")

    def abre_via_cnpj(self, event=None):
        '''Abre consulta no VIA para CNPJ'''
        webbrowser.open("https://via7.suiterfb.receita.fazenda/via/private/pages/consultar_cnpj_e1.jsf")
    ...
    def roda_bk(self, event=None):
        ...
        try:
            self.imprime_saida('Processando backup em ' + folder + '\n')
        except TypeError:
    ...
    def roda_google(self, event=None):
        ...
        if pesquisa == '':
            self.imprime_saida('Informe o termo ou endereço para busca.\n')
            return
        if self.google_chrome:  # se localizado o google-chrome
            ...
            if self.radio_google_var.get() == 1:
                webbrowser.get('chrome').open(
                    f'https://www.google.com/search?q={pesquisa}+site:receita.economia.gov.br')
            else:
    ...
    def formata_txt(self, event=None):
        ...
        if texto == '':
            self.imprime_saida('Informe o texto a ser formatado.\n')
            return
        saida = ''
